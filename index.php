...
$query = 'SELECT * FROM menu LIMIT 4';
$result = mysqli_query($connect_db, $query);

$query_team = 'SELECT * FROM team LIMIT 3';
$result_team = mysqli_query($connect_db, $query_team);

$query_testimony = 'SELECT * FROM testimony';
$result_testimony = mysqli_query($connect_db, $query_testimony);

$query_specialties = 'SELECT * FROM specialties';
$result_specialties = mysqli_query($connect_db, $query_specialties);
...
if (isset($_POST['submit'])) {
    ...
    $query = 'INSERT INTO reservation VALUES(NULL,"' . $name . '","' . $email . '","' . $phoneNumber . '","' . $date . '","' . $time . '","' . $personNum . '","' . $message . '")';
    $result = mysqli_query($connect_db, $query);
    $_SESSION['add'] = 'The data has been sent successfully';
    header('location:#gtco-reservation');
}
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav d-flex justify-content-between">
                        ...
                        ?>
                            <li class="nav-item">
                                <a id="side-search-open" class="nav-link btn btn-light" href="backend/dashboard.php">
                                    Dashboard
                                </a>
                            </li>
                        <?php
                        ...
                        ?>
                            <li class="nav-item">
                                <a id="side-search-open" class="nav-link btn btn-light" href="backend/login.php">
                                    Login
                                </a>
                            </li>
                            <li class="nav-item">
                                <a id="side-search-open" class="nav-link btn btn-light" href="backend/register.php">
                                    Register
                                </a>
                            </li>
        ...
        <section id="gtco-special-dishes" class="bg-grey section-padding">
            <div class="container">
                <div class="section-content">
                    ...
                    <?php
                    while ($specialties = mysqli_fetch_array($result_specialties)) {

                    ?>
                        <div class="row mt-5">
                            <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                                <img src="backend/img/<?php echo $specialties['image'] ?>" alt="" class="img-fluid shadow w-100">
                            </div>
                            <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center order-1 order-md-2 py-5">
                                <h2 class="special-number">0<?php echo $specialties['id'] ?>.</h2>
                                <div class="dishes-text">
                                    <h3><span><?php echo $specialties['name'] ?></span><br> <?php echo $specialties['type'] ?></h3>
                                    <p class="pt-3"><?php echo $specialties['description'] ?></p>
                                    <h3 class="special-dishes-price"><?php echo $specialties['price'] ?></h3>
                            ...
                            ?>
                                <div class="menus d-flex align-items-center">
                                    <div class="menu-img rounded-circle">
                                        <img class="img-fluid" src="backend/img/<?php echo $rows['image'] ?>" alt="">
                                    </div>
                                    <div class="text-wrap">
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col-4">
                                                <h4 class="text-muted menu-price">$<?php echo $rows['price'] ?></h4>
                                            </div>
                                        </div>
                ...
                <div class="section-content">
                    ...
                    <div class="row">
                        ...
                        <div class="testi-content testi-carousel owl-carousel">
                            <?php
                            while ($testimony = mysqli_fetch_array($result_testimony)) {
                            ?>
                                <div class="testi-item">
                                    <i class="testi-icon fa fa-3x fa-quote-left"></i>
                                    <p class="testi-text"><?php $testimony['quote'] ?></p>
                                    <p class="testi-author"><?php $testimony['sayes'] ?></p>
            ...
            <div class="container">
                <div class="section-content">
                    ...
                    <div class="row">
                        ...
                        <?php
                        while ($team = mysqli_fetch_array($result_team)) {
                        ?>
                            <div class="col-md-4">
                                <div class="team-card mb-5">
                                    <img class="img-fluid" src="backEnd/img/<?php echo $team['image'] ?>" alt="">
                                    <div class="team-desc">
                                        <h4 class="mb-0"><?php echo $team['name'] ?></h4>
                                        <p class="mb-1"><?php echo $team['jop'] ?></p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                            <input type="date" class="form-control datetimepicker-input" data-target="#datetimepicker4" name="date" placeholder="Date" />
                                    ...
                                    <div class="col-md-6 form-group">
                                        <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                            <input type="time" class="form-control datetimepicker-input" data-target="#datetimepicker3" placeholder="Time" name="time" />
                                    ...
                                    <div class="col-md-12 form-group">
                                        <select class="form-control" name="personNum" id="selectPerson">
                                            <option></option>
